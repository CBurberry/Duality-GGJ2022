...
public class LootGenerator : MonoBehaviour
{
    ...
    {
        Debug.Log("GenLoot Script started");
        MaterialItem loot;
        ...
        loot.title = loot.matTags[matNameRoll].title;
        //find a prefix and suffix
        Debug.Log("GenLoot Script checkpoint B");
        /////
        // Tags
        /////
        ...
        if(inv)
            inv.container.Add(loot);
        MainCharacter.Instance.inventory.container.Add(loot);
